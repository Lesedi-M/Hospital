...
<head>
  ...
  <title>One Health - Medical </title>
...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('myappointment')}}" style="background-color:rgb(69, 99, 26); color: white; border-radius: 15px;">My Appointment</a>
            </li>

            <li class="nav-item" style="padding-left: 15px;" >
              <form method="POST" action="{{ route('logout') }}">
                  @csrf
                  <a href="#" onclick="event.preventDefault(); this.closest('form').submit();" class="nav-link" style="border: solid; border-radius: 15px;">Logout</a>
              </form>
          </li>
  ...
  <div style="padding-top: 70px;">
    <table align="center" style="padding:70px;">
        <tr style="background-color: rgb(70, 65, 65);">
        ...
        <tr style="background-color: rgb(43, 39, 39);" align="center">
    ...
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          ...
          <a href="#" class="footer-link">123-573-7582</a>
